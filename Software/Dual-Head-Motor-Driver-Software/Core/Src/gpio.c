...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : M1_nFAULT_Pin GPIO3_Pin */
  GPIO_InitStruct.Pin = M1_nFAULT_Pin|GPIO3_Pin;
  ...
  /*Configure GPIO pins : GPIO1_Pin MICRO_SW_Pin */
  GPIO_InitStruct.Pin = GPIO1_Pin|MICRO_SW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : GPIO2_Pin M2_nFAULT_Pin M3_nFAULT_Pin */
  GPIO_InitStruct.Pin = GPIO2_Pin|M2_nFAULT_Pin|M3_nFAULT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
